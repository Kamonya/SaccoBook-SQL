...
namespace SaccoBook.AppResources
{
    ...
    {
        /*
        * function encrypts a specified PDF document and stores in specified location
        */
        public static string PasswordProtectPDF(string Source, string Destination, string OwnerPassword, string UserPassword)
        {
            using (PdfDocumentProcessor pdfDocumentProcessor = new PdfDocumentProcessor())
            {
                ...
                pdfDocumentProcessor.SaveDocument(Destination, new PdfSaveOptions() { EncryptionOptions = encryptionOptions });
            }
            return Destination;
        }
        ...
        */
        public static void LoadReport(XtraReport report, XtraForm form)
        {
            SplashScreenManager.ShowForm(form, typeof(AppWaitForm), true, true, false);
            SplashScreenManager.Default.SetWaitFormCaption("Please wait");
            SplashScreenManager.Default.SetWaitFormDescription("Loading...");
            //// Show the report's preview. 
            typeof(DevExpress.XtraPrinting.Native.MAPI).GetField("unicodeSupported", System.Reflection.BindingFlags.Static | System.Reflection.BindingFlags.NonPublic).SetValue(null, false);
