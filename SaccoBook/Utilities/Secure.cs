            ...
            else
            {
                ...
                if (block == false)
                {
                    ...
                    if (chinstall == "First")
                    {
                        ...
                        DialogResult ds = XtraMessageBox.Show("You are using trial version of the software! Would you Like to Activate it Now!", "Product key", MessageBoxButtons.YesNo, MessageBoxIcon.Information);
                        if (ds == DialogResult.Yes)
                        {
                            RegisterSoftware f1 = new RegisterSoftware(appPassword, globalPath);
                    ...
                    else
                    {
                        ...
                        {
                            DialogResult ds = XtraMessageBox.Show("You are using trial version of the software.\n\nYou have " + status + " days left to Activate! Would you Like to Activate it now!", "Product key", MessageBoxButtons.YesNo, MessageBoxIcon.Information);
                            if (ds == DialogResult.Yes)
                            {
                                RegisterSoftware f1 = new RegisterSoftware(appPassword, globalPath);
                                DialogResult ds1 = f1.ShowDialog();
