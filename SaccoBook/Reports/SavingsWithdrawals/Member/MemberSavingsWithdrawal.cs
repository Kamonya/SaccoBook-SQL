...
namespace SaccoBook.Reports.SavingsWithdrawals.Member
{
    public partial class MemberSavingsWithdrawal : DevExpress.XtraReports.UI.XtraReport
    {
        public MemberSavingsWithdrawal()
        {
            InitializeComponent();
        }

        private void MemberSavingsWithdrawal_ParametersRequestBeforeShow(object sender, DevExpress.XtraReports.Parameters.ParametersRequestEventArgs e)
        {
        ...
        private void MemberSavingsWithdrawal_ParametersRequestSubmit(object sender, DevExpress.XtraReports.Parameters.ParametersRequestEventArgs e)
        {
            string ReportType = this.Parameters["ReportType"].Value.ToString();
        ...
        private void MemberSavingsWithdrawal_ParametersRequestValueChanged(object sender, DevExpress.XtraReports.Parameters.ParametersRequestValueChangedEventArgs e)
        {
            string ReportType = this.Parameters["ReportType"].Value.ToString();
