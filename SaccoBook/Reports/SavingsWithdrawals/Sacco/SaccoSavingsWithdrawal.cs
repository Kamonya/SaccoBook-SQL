...
namespace SaccoBook.Reports.SavingsWithdrawals.Sacco
{
    public partial class SaccoSavingsWithdrawal : DevExpress.XtraReports.UI.XtraReport
    {
        public SaccoSavingsWithdrawal()
        {
            InitializeComponent();
        }

        private void SaccoSavingsWithdrawal_ParametersRequestBeforeShow(object sender, DevExpress.XtraReports.Parameters.ParametersRequestEventArgs e)
        {
        ...
        private void SaccoSavingsWithdrawal_ParametersRequestSubmit(object sender, DevExpress.XtraReports.Parameters.ParametersRequestEventArgs e)
        {           
        ...
        private void SaccoSavingsWithdrawal_ParametersRequestValueChanged(object sender, DevExpress.XtraReports.Parameters.ParametersRequestValueChangedEventArgs e)
        {
            string ReportType = this.Parameters["ReportType"].Value.ToString();
